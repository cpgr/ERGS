...
[AuxKernels]
  [./aperture_evolution]
    type = ergsApertureAux                             #takes aperture material as input and produce aperture variable
    variable = aperture
  ...
  [./get_coeff_c]
    type = ParsedAux
    variable = coeff_c
    function = if(saturation_water>0.001,aperture*saturation_water*1251*r_m,aperture*1251*r_m)      #takes aperture variable as input
...
[ICs]                                   # will become old/initial aperture
  [./aperture_input]
    type = SBParameterFieldIC
    variable = aperture_input    
    file_name = gap000_N18S_0MPa_40_50_mesh.txt  #ParameterField.txt
  [../]
#  [aperture]
#    type = ergsApertureIC
#    variable = aperture
