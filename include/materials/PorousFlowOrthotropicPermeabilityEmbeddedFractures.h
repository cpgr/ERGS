 ...
 * to the fracture.
 */
class PorousFlowOrthotropicPermeabilityEmbeddedFractures : public PorousFlowPermeabilityBase
{
public:
	static InputParameters validParams();

	PorousFlowOrthotropicPermeabilityEmbeddedFractures(const InputParameters& parameters);
