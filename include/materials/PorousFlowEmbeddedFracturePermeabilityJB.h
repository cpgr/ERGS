 ...
 * to the fracture.
 */
class PorousFlowEmbeddedFracturePermeabilityJB : public PorousFlowPermeabilityBase
{
public:
	static InputParameters validParams();

	PorousFlowEmbeddedFracturePermeabilityJB(const InputParameters& parameters);
