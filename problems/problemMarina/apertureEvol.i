...
[Kernels]
  ...
  [./react2]                             # instead of working with xnacl, this kernel is converting xnacl to xnacl_control and acting on xnacl_control
    type = PorousFlowHeatMassTransfer
    variable = xnacl                     # coupled variable (u)
    v = xnacl_control                    # kernel variable (v), i.e., the value that the PorousFlowHeatMassT is working with or working on
    transfer_coefficient = coeff_c       # basically, coeff_c * (xnacl - xnacl_control) CORRECT!
