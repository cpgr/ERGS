...
[AuxKernels]
  ...
  [./change_aperture]
    type = ParsedAux
    variable = aperture
    function = if(r_m=0.0,aperture_old,(aperture_old-aperture_old*saturation_water*0.5765*dtime_var*r_m*(xnacl-0.2678)))
  ...
  [./get_r_m]
    type = ParsedAux
    variable = r_m
    function = if(xnacl<=0.26780,0.0,10)
    args = 'xnacl'
...
[ICs]
  [./aperture_input]
    ...
    variable = aperture
    file_name = kField.txt         #gap000_N18S_0MPa_40_50_mesh.txt  #ParameterField.txt
  [../]
[]
