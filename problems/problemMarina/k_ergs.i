[Mesh]
  [efm]
   ...
   file = kamlotFlo2.msh  #kamlotFlo3.msh #kamlotFlosquare.msh  # kamlotFlo2.msh  #kamlotFlo3lite.msh #
  []
[]
...
[Materials]
 ...
 [relperm_water0]
  ...
  []
#    [permeability_casing]
#     type = ergsEmbeddedFracturePermeability  #ergsEmbeddedOrthotropicFracturePermeability 
#     Random_field = true
#     rotation_angleXY = rotxy_aux
#     rotation_angleYZ = rotyz_aux
#     alpha = " 0.024 0.024 0.024"                   
...
[Executioner]
  ...
  [TimeStepper]
    ...
    dt =   1e-1 #1e0                          #1e-1 for denser mesh. Use temp_min and press_min values for sparse mesh          
