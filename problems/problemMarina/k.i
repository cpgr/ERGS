####NB: converge initially because ap_input = zero
[Mesh]
  [efm]
...
[AuxKernels]
  ...
  [change_aperture]
    type = ParsedAux
    variable = aperture
    function =  if(r_m=0.0,aperture_old,(aperture_old-aperture_old*swater*0.5765*dtime_var*r_m*(xnacl-0.367)))
    args = 'aperture_old aperture r_m dtime_var swater xnacl'      
    block = 'rocksalt fluid' 
 ...
 [relperm_water0]
  ...
  []
    [permeability_rocksalt]
     type = ergsEmbeddedOrthotropicFracturePermeability #PorousFlowEmbeddedOrthotropicFracturePermeability #PFOrthoEM
     Random_field = true
  ...
  []
    [permeability_casing]
     type = PorousFlowEmbeddedOrthotropicFracturePermeability #PFOrthoEM
     Random_field = true
     rotation_angleXY = rotxy_aux
     rotation_angleYZ = rotyz_aux
     alpha = " 0.024 0.024 0.024"                   
...
#    rm = r_m
#    Dt = dtime_var
#    initial_fracture_aperture_input = aperture_input
