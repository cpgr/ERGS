...
[BCs]
 ...
 # []
  ...
  [externalBoundary_pressure_right_x] 
    type = DirichletBC
    variable = pwater
    value =  101325
    use_displaced_mesh = false
    boundary = right
  []
  [externalBoundary_pressure_back_y]
    type = DirichletBC
    variable = pwater
    value =  101325
    use_displaced_mesh = false
    boundary = back
  []
    [externalBoundary_pressure_top_z]
    type = DirichletBC
    variable = pwater
    value =  101325
    use_displaced_mesh = false
