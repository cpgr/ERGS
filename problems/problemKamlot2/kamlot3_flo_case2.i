...
[Functions]
  [my_flux2] 
  type = ParsedFunction 
   value = 'if(t<=525, -1.1e-4, if(t <= 1800,-5.56e-4, if(t<= 1875,-5.56e-3,0)))'  
#  value = 'if(t<=525, -9.9e-5, if(t <= 1800,-5.004e-4, if(t<= 1875,-5.004e-3,0)))' 
#   value = 'if(t<=525, -1.1e-5, if(t <= 1800,-5.56e-5, if(t<= 1875,-5.56e-4,0)))'  
#   value = 'if(t<=525, -9.9e-6, if(t <= 1800,-5.004e-5, if(t<= 1875,-5.004e-4,0)))'   
#   value = 'if(t<=480, -1.1e-5, if(t <= 1800,-5.56e-4, if(t<= 1875,-3.56e-4,0)))'  
#   value = 'if(t<=525, -9.9e-6, if(t <= 1800,-5.004e-5, if(t<= 1875,-5.004e-4,0)))' 
  []
