...
#    block = 'casing'
#  []
#   [effective_fluid_pressure_fluid]
#    type = PorousFlowEffectiveFluidPressure
#    block = 'fluid injection_region'
#  []
...
#  []
  ...
  [water_injection]
    ...
    variable = pwater
    flux_function = -2.78e-6  #my_flux  # -1E-10
    use_displaced_mesh = false
  []
...
[Functions]
  [my_flux]
  type = ParsedFunction 
  value = 'if(t <= 300,-1.39e-7,-2.78e-6)'    #'if(t <= 300,-5.5e-7,-2.78e-5)'   #
  []
...
# dt = 1e2  
  ...
  []
  nl_abs_tol = 1e-10  # nl tolerance need to be set very small since residual is much lower
[]
