[Mesh]
  [efm]
   ...
   file = kamlot3newnew.msh  #kamlot3newR.msh  #kamlot5.msh
  []
[]
...
[Materials]
 ...
 []
  ...
  [elasticity_tensor_fluid]
    type = ComputeIsotropicElasticityTensor
    youngs_modulus = 1e5                  # 1e-18 #2e10   #1e-4 #1e-4                    #1e-9
...
[Functions]
  [my_flux1]
  type = ParsedFunction 
  value = 'if(t <= 300,-1.39e-7,-2.78e-6)'  #'if(t <= 300,-1.39e-7,-2.78e-6)' 
  []
  [my_flux2]
  type = ParsedFunction 
  value = 'if(t <= 300, 5.5e-7, -2.78e-5)'
  []
