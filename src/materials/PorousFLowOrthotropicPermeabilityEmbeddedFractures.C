#include "PorousFlowOrthotropicPermeabilityEmbeddedFractures.h"

registerMooseObject("PorousFlowApp", PorousFlowOrthotropicPermeabilityEmbeddedFractures);

InputParameters
PorousFlowOrthotropicPermeabilityEmbeddedFractures::validParams()
{
...
PorousFlowOrthotropicPermeabilityEmbeddedFractures::PorousFlowOrthotropicPermeabilityEmbeddedFractures(
...
{
  if (_a[j] = 0.0)
    mooseError("PorousFlowOrthotropicPermeabilityEmbeddedFractures: Mean fracture distance value"
...
void
PorousFlowOrthotropicPermeabilityEmbeddedFractures::computeQpProperties()
{
