...
registerMooseObject("PorousFlowApp", PorousFlowEmbeddedFracturePermeability);

InputParameters
PorousFlowEmbeddedFracturePermeability::validParams()
{
...
PorousFlowEmbeddedFracturePermeability::PorousFlowEmbeddedFracturePermeability(const InputParameters & parameters)
...
void
PorousFlowEmbeddedFracturePermeability::computeQpProperties()
{
